...
const unsigned int TRIG_B = 4;
// const unsigned int TRIG_C = 2;
const unsigned int ECHO_A = 3; // Echo of Front Ultrasonic
const unsigned int ECHO_B = 5; // Echo of Left Ultrasonic
...
// Ultrasonic instance
Ultrasonic ultrasonicFront(TRIG_A, ECHO_A);
Ultrasonic ultrasonicLeft(TRIG_B, ECHO_B);
Ultrasonic ultrasonicRight(TRIG_A, ECHO_C);
...
//       motorSpeedB = (motorDirecitionB / 180) * 255;
